package com.java.db.pool.config;
...
public class DbBean {
    ...
    private String url = "jdbc:mysql://localhost:3306/aop";

    private String userName = "root";

    private String password = "root";

    private String poolName = "thread01"; // 连接名字
    ...
    private long connectionTimeOut = 1000 * 60 * 20; //连接超时事件，默认20分钟
