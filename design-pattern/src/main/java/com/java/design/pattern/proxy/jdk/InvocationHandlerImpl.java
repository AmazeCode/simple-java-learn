package com.java.design.pattern.proxy.jdk;

import com.java.design.pattern.proxy.statics.IUserDao;
import com.java.design.pattern.proxy.statics.IUserDaoImpl;
